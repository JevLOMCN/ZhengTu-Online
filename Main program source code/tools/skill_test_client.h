...
class zebraClient : public zTCPClient , zAStar<>, public zAStar<2>
{
	...
	public:
		...
		zebraClient(
			...
			: zTCPClient(name, ip, port , true) , _one_sec(1) , _five_sec(5) , _ten_sec(10) , _one_min(60)
			{
				moveto_x = 0;
				moveto_y = 0;
				x = 0;
		...
		zebraClient(
			...
			: zTCPClient(name, ip, port , true) , _one_sec(1) , _five_sec(5) , _ten_sec(10) , _one_min(60),user(u)
			{
				moveto_x = 0;
				moveto_y = 0;
				x = 0;
