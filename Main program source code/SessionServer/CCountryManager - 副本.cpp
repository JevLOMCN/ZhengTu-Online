...
{	
    ...
    case Cmd::REQ_LOONGALTAR_LIST_PARA:
        ...
        break;
	case Cmd::REQ_ZHANLI_LIST_PARA://2023-05-10 add by zhanli
        {
            Cmd::ReqAltarListLoongUserCmd* rev = (Cmd::ReqAltarListLoongUserCmd *)ptNullCmd;
            if ( pUser && rev )
            {
                ...
                pSend->altarNum = 0;
				Cmd::SelectUserInfoA info[50];
				{
					Zebra::logger->trace("CCountry::replyZhanLiNum");
					...
					retcode = SessionService::dbConnPool->exeSelectLimit(handle, "`CHARBASE`", charinfo_define, NULL, "ZHANLI DESC"/* , CHARID DESC" */, 50, (BYTE *)(&info));
							...
							|| 0 == retcode)
					{
						...
						//ret10->num = 0;
						bzero(info, sizeof(Cmd::SelectUserInfoA)*50);
