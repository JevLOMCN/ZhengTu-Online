 ...
 * \return 无
 */
CGuiChongzhiTrade::CGuiChongzhiTrade(void)
: m_dwRepair(CGuiNpcDialog::eChongzhi)
{
	FUNCTION_BEGIN;
 ...
 * \return 无
 */
void CGuiChongzhiTrade::OnClose(void)
{
	FUNCTION_BEGIN;
	...
	GetGameGuiManager()->m_guiChongzhiTrade = NULL;
	GetGameGuiManager()->m_guiChongzhiTrade = NULL;
 ...
 * \return 无
 */
void CGuiChongzhiTrade::OnCreate()
{
	FUNCTION_BEGIN;
	...
	m2_pStaChongzhi = GetEditBox(1002); //soke 充值点显示
	m2_pStaChongzhi->SetEnabled(false);
...
//soke 增加窗口支持充值点显示
HRESULT CGuiChongzhiTrade::OnRender(float fElapsedTime)
{
	FUNCTION_BEGIN;
	...
	// 刷新当前充值点数
	DWORD dwChongzhi = GetScene()->GetMainCharacter()->GetProperty()->chongzhi;
	m2_pStaChongzhi->SetText(Chongzhi2String(dwChongzhi));
 ...
 * \return 无
 */
void CGuiChongzhiTrade::AddBuyObject(ObjectBase_t* pObject,int nNum,int nLevel)
{
	FUNCTION_BEGIN;
 ...
 * \return 无
 */
void CGuiChongzhiTrade::AddBuyPage(const char* pageName,const char* pszBuyParam)
{
	FUNCTION_BEGIN;
...
void CGuiChongzhiTrade::SetPage(int nPage)
{
...
* \return 无
*/
void CGuiChongzhiTrade::SetParam(std::vector<std::string> & params)
{
	FUNCTION_BEGIN;
	...
	if(m_dwRepair!=CGuiNpcDialog::eChongzhi)
	{
		if(params.size() > index)
		{
...
* \return 检查结果
*/
bool CGuiChongzhiTrade::IsBuyObject(DWORD dwObjectID)
{
	FUNCTION_BEGIN;
...
* \return 检查结果
*/
bool CGuiChongzhiTrade::IsSellObject(DWORD dwObjectID)
{
	FUNCTION_BEGIN;
...
* \return 检查结果
*/
bool CGuiChongzhiTrade::IsRepairObject(DWORD dwObjectID)
{
	FUNCTION_BEGIN;
...
* \return 无
*/
void CGuiChongzhiTrade::RefreshRepairMoney()
{
	FUNCTION_BEGIN;
...
* \return 消息处理结果
*/
bool CGuiChongzhiTrade::OnGuiEvent(UINT nEvent,UINT nID,CGuiControl* pControl)
{
	FUNCTION_BEGIN;
