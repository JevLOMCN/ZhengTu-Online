...
#define FLOAT_ACCESS_KEY_GROUP	255
#define FLOAT_ACCESS_KEY_NUM	10
#define EMOTION_ACCESS_KEY_GROUP 100


extern int g_nFloatAccessBtnLeft;
extern int g_nFloatAccessBtnTop ;	
extern int g_FloatAccessBtnSpace ;
...
public:
	///快捷键按钮
	CGuiButton* m_pBtnAccessKey[FLOAT_ACCESS_KEY_NUM];
	///快捷键tips
