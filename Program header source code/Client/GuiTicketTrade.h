...
class CGuiTicketTrade :
	public CGuiDialog
{
	///买物品数据
	std::vector<stTicketBuyObject> m_aBuyObject;  
	///卖物品数据
	std::vector<stTicketBuyObject> m_aSellObject;
	///修理物品数据
	std::vector<stTicketBuyObject> m_aRepairObject;
	///是否可修理
	DWORD m_dwRepair;
	///多选页
	CGuiTab*                 m_pTab;
...
public:
	...
	///积分显示框
	CGuiEditBox* m2_pStaTicket; //积分

	///买物品显示网格
	CGuiTable*	m_pTable;
	CGuiTicketTrade(void);
	void OnClose(void);
	void OnCreate();
