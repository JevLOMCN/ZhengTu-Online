...
void TiXmlBase::PutString( const TIXML_STRING& str, TIXML_OSTREAM* stream,bool bConvLine )
{
	TIXML_STRING buffer;
	PutString( str, &buffer ,bConvLine);
	(*stream) << buffer;
}

void TiXmlBase::PutString( const TIXML_STRING& str, TIXML_STRING* outString ,bool bConvLine)
{
	int i=0;
