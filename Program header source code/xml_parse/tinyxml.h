...
protected:
	...
	*/
	...
	static void PutString( const TIXML_STRING& str, TIXML_OSTREAM* out,bool bConvLine = false);

	static void PutString( const TIXML_STRING& str, TIXML_STRING* out,bool bConvLine = false);
