================================================================================
    MICROSOFT 基础类库： ViewGL 项目概述
===============================================================================

应用程序向导已为您创建了此 ViewGL 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 ViewGL 应用程序的每个文件的内容摘要。
...
res\Toolbar.bmp
    ...
    更新 ViewGL.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

ViewGLDoc.h、ViewGLDoc.cpp - 文档
    这些文件包含 CViewGLDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CViewGLDoc::Serialize）。
    此文档将具有下列字符串：
        文件扩展名：      gl
        文件类型 ID：        ViewGL.Document
        主框架标题：  ViewGL
        文档类型名称：       ViewGL
        筛选器名称：         ViewGL Files (*.gl)
        文件的新简称： ViewGL
        文件类型全称： ViewGL.Document
ViewGLView.h、ViewGLView.cpp - 文档视图
    这些文件包含 CViewGLView 类。
    CViewGLView 对象用于查看 CViewGLDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 ViewGL.pch 的预编译头文件 (PCH)
